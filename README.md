<div align="center">
    <picture>
        <source media="(prefers-color-scheme: dark)" srcset="banner-green.svg?v=7">
        <source media="(prefers-color-scheme: light)" srcset="banner-green-light.svg?v=7">
        <img alt="Animated GitHub Banner" src="banner-green.svg?v=7">
    </picture>
</div>
  ...
  <table border="0" style="border: none;">
    <tr style="border: none;">
      <td width="35%" align="center" style="border: none; background: transparent;">
        <img src="lanyard-green.svg?v=7" alt="Swinging Lanyard" width="300">
      </td>
